...
# Create new route to show all the stations
...
# Create new route to return the temperature observations for the previous year
...
# Create route to show data statistics
